...
spa.shell = (function() {
    ...
    //Arguments:
    //  * arg_map - The map describing what part of the URI anchor we want changeed
    //Returns: boolean
    //  * true - the Anchor portion of the URI was update
    //  * false - the Anchor protion of the URI could not be updated
    //Action:
    //  The current anchor rep stored in stateMap.anchorMap().
    //  See uriAnchor for a discussion of encoding
    //  This method
    //      * Creates a copy if this map using copyAnchorMap().
    //      * Modifies the key-value using arg_map.
    //      * Manages the distanction between independent and dependent values in the encoding.
    //      * Attempts to change the URI using uriAnchor.
    //      * Return true on successm and false on failure;
    ...
    //Purpose: Handles the hashchange evnet
    //Arguments:
    ...
    //Action:
    //  Populates $cintainer with the shell of the UI
    ...
    initModule = function($container) {
        ...
        //the trigger event, which is used to ensure the anchor is
        //considered on-load
        $(window)
